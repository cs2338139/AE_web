  ...
  <div>
    <div class="absolute w-full">
      <div ref="target">
        ...
        <div class="star right-64 top-120 2xl:opacity-50 rotate-45  4xl:right-104 3x"></div>
        <div class="rain-1 right-24 top-64 2xl:opacity-0 4xl:right-64"></div>
        <div class="leaves top-182 2xl:opacity-80 right-0"></div>
        <div class="star right-96 top-212 2xl:opacity-50"></div>

        <div class="star left-28 top-48 2xl:opacity-50  4xl:left-96"></div>
        <div class="rain left-16 top-14 2xl:opacity-0 4xl:left-52"></div>
        <div class="truck left-8 top-146 -rotate-12 3xl:opacity-0"></div>
...
@layer components {
  ...
  .star {
    @apply bg-Star-image h-11 w-8 image 4xl:scale-150 sm:scale-50;
  }

  .rain {
    @apply h-96 image w-36 bg-Rain-image 4xl:scale-150;
  }

  .rain-1 {
    @apply h-80 image bg-Rain-1-image w-48 4xl:scale-150;
  }

  .leaves {
    @apply image w-36 bg-Leaves-image h-48 2xl:w-28 origin-right 4xl:scale-150;
  }

  .truck {
    @apply h-52 image bg-Truck-image w-56 origin-left 4xl:scale-150;
  }
}
</style>
