...
<template>
  <div ref="target">
    ...
    <div class="image h-11 bg-Star-image right-100 top-480 w-10 rotate-45"></div>
    <div class="image h-11 bg-Star-image right-40 top-560 w-5"></div>
    <div class="image h-11 bg-Star-image right-146 top-520 w-6"></div>
    <div class="image h-11 bg-Star-image right-80 top-600 w-7 rotate-45"></div>
    ...
    <div class="image h-11 bg-Star-image left-64 top-380 w-5 rotate-45"></div>
    <div class="image h-11 bg-Star-image left-146 top-420 w-5"></div>
    <div class="image h-11 bg-Star-image left-24 top-440 w-8"></div>
    <div class="image h-11 bg-Star-image left-72 top-460 w-10"></div>
    <div class="image h-11 bg-Star-image left-72 top-520 w-7"></div>
    <div class="image h-11 bg-Star-image left-150 top-540 w-10 rotate-45"></div>
    <div class="image h-11 bg-Star-image left-36 top-580 w-9"></div>
    <div class="image h-11 bg-Star-image left-72 top-620 w-6 rotate-45"></div>
