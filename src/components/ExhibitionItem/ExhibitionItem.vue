...
<template>
  <div class="relative flex mx-auto items-center justify-center bgCloud 2xl:w-2/3 sm:w-full ">
    <slot></slot>
    <div class="flex flex-col items-end w-3/5 sm:items-center sm:w-4/5 ">
      <div class="flex w-full md:flex-col md:items-center sm:w-4/5">
