...
export default {
  ...
  methods: {
    LoadJson() {
      axios
        .get("Data/" + this.$route.params.activityID + "/ChildrenArtList.json")
        .then((response) => {
...
<template>
  <div class="wrap">
    ...
    <div class="flex flex-wrap justify-between">
      <ActivityItem v-for="(i, index) in childrenArtList" :href="'/activities/' + $route.params.activityID + '/' + index" :img="'Data/' + $route.params.activityID + '/' + index + '/cover.jpg'" :typeName="i.typeName" :class="{ invisible: i.title === 'none' }">
