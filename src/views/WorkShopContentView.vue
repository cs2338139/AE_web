  ...
  <div class="wrap">
    ...
    <div class="grid grid-cols-5 gap-x-16 gap-y-10 h-960px">
      ...
      <div class="col-start-4 col-end-6 row-start-1 row-end-4 col-start">
        <div class="w-4/5 h-full">
          <div class="mt-3 mb-16">
            ...
            <div class="text-3xl font-normal">14:00－15:30</div>
          </div>
          ...
          <div class="mb-16">
            ...
            <a href="" class="my-2 text-xl font-bold text-zinc-500"><div>報名表單｜點我報名</div></a>
            <a href="" class="my-2 text-xl font-bold text-zinc-500"><div>報名須知｜點我了解</div></a>
          </div>
      ...
      <div class="col-start-1 col-end-4 row-start-4 row-end-6">
        <div class="text-3xl font-bold">漫遊城市：泥塑鏤空杯墊製作</div>
        <br />
        <div class="text-lg">
          我們的房子是什麼樣子呢！ <br />
          課程會使用模具與各式小工具，在黏土上按壓出房子的形狀，製作出一幅屬於自己的城市風景杯墊。
        </div>
        <hr class="my-8 border-zinc-400" />
        <div class="text-lg">授課講師 | 周殷竹</div>
      </div>
    </div>
  </div>

  <div class="fixed bottom-0 left-0 z-50 w-full h-screen bg-black-05">
